...
function bootstrap3_searchform($ajax = true, $autocomplete = true) {
    ...
    print '<form action="'.wl('search').'" accept-charset="utf-8" class="navbar-form navbar-left search" id="dw__search" method="get" role="search"><div class="no">';
...
function bootstrap3_youarehere() {
    ...
    echo '<li>';
    tpl_link(wl(null), '<i class="fa fa-fw fa-home"></i>', 'title="'. $conf['start'] .'"');
    echo '</li>';
